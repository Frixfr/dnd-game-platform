...
export const PlayerNotesPage: React.FC = () => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="bg-[#0A1F44]/50 rounded-lg border border-[#F2E9E4]/20 shadow p-6">
        <textarea
          value={notes}
          onChange={(e) => setNotes(e.target.value)}
          className="w-full h-96 p-3 bg-[#0A1F44]/70 border border-[#F2E9E4]/20 rounded-lg resize-y text-[#F2E9E4] placeholder:text-[#8b9bb4] focus:outline-none focus:ring-2 focus:ring-[#FF0026]/50"
