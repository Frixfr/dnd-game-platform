  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4 md:space-y-6">
      ...
      <div className="bg-gray-50 rounded-xl p-4 md:p-5 border border-gray-100">
        <h3 className="text-md font-semibold text-gray-700 mb-3 flex items-center gap-2">👾 NPC</h3>
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
            ...
            <div>
              ...
              <select name="aggression" value={formData.aggression} onChange={handleInputChange} className="w-full px-3 py-2 border rounded-xl" disabled={loading}>
      ...
      <div className="flex flex-col-reverse sm:flex-row justify-between items-center gap-3 pt-4 border-t">
        <button type="button" onClick={onDelete} className="w-full sm:w-auto px-4 py-2 bg-red-500 text-white rounded-xl hover:bg-red-600 disabled:opacity-50" disabled={loading || deleting}>{deleting ? 'Удаление...' : '🗑️ Удалить NPC'}</button>
