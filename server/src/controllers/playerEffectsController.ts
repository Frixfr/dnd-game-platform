...
export const playerEffectsController = {
  async getAll(req: Request, res: Response) {
    try {
      ...
      const data = await playerEffectsService.getAll({
        player_id,
        effect_id,
        source_type,
        with_details,
  ...
  async create(req: Request, res: Response) {
    ...
    try {
      const result = await playerEffectsService.create({
        player_id,
        effect_id,
        source_type,
        source_id,
      ...
      getIO().emit("player_effect:created", result);
  ...
  async delete(req: Request, res: Response) {
    ...
    try {
      await playerEffectsService.delete(player_id, effect_id);
      getIO().emit("player_effect:deleted", { player_id, effect_id });
